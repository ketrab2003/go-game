...
static const int BOARD_OFFSET = 1;		// distance between board and legend
static const bool BOARD_ON_RIGHT = true;  // location of board relative to the legend
...
static const char* const PERSONAL_DATA = "Bartlomiej Krawisz, 193319";  // for window title and legend
static const int PERSONAL_DATA_POSITION_X = 23;
static const int PERSONAL_DATA_POSITION_Y = 0;

static const char* const DONE_LIST =
"Done:\n"
"a,b,c,d,e,f,g,h,i,j,k,l";
static const int DONE_LIST_POSITION_X = 23;
static const int DONE_LIST_POSITION_Y = 2;

static const char* const SCORE_MESSAGE_FORMAT = "B: %d W: %d (+%.1f)";	// must contain %d for black's score, %d for white's score, and %.1f for white's bonus points
...
static const char* const LOCATION_MESSAGE_FORMAT = "X: %d Y: %d";		// must contain %d for X position, and %d for Y position
...
static const char* const HANDICAP_MESSAGE = "handicap mode";
static const char* const SUICIDE_MESSAGE = "move is suicidal\7";
static const char* const OCCUPIED_MESSAGE = "place is occupied\7";
static const char* const ALREADY_PLACED_MESSAGE = "already placed\7";
static const char* const KO_MESSAGE = "ko rule\7";
...
// other messages
static const char* const FILENAME_QUERY = "Provide filename: ";
static const char* const SAVING_HEADER = "### SAVING GAME ###";
static const char* const LOADING_HEADER = "### LOADING GAME ###";
static const char* const SAVE_SUCCESS = "Game saved!";
static const char* const SAVE_ERROR = "Failed to save!";
static const char* const LOAD_SUCCESS = "Game loaded!";
static const char* const LOAD_ERROR = "Failed to load!";

static const char* const BLACK_WON_MESSAGE = "Black won!";
static const char* const WHITE_WON_MESSAGE = "White won!";

static const char* const GAME_FINISH_DIALOG_INSTRUCTIONS =
"Press n to play new game\n"
"Press ESC to cancel\n"
"Press q to quit\n";

static const char* const CHOOSE_BOARD_SIZE_HEADER = "### Choose board size ###";
static const char* const BOARD_SIZES[] = { "9x9", "13x13", "19x19", "other" };
static const int BOARD_SIZE_VALUES[] = { 9, 13, 19, -1 };   // sizes defined in BOARD_SIZES (-1 means user input)
static const char* const BOARD_SIZE_QUERY = "Provide board size: ";
